            ...
            for (x, y, r) in circles:
                ...
                if r > 10:  # Minimum threshhold
                    ...
                    if roi is not None and roi.shape[0] > 0 and roi.shape[1] > 0:
                        ...
                        _, thresh = cv2.threshold(roi_gray, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, 255, cv2.THRESH_BINARY)
